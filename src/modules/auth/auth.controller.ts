...
import { signUpValidation, loginValidation ,forgetPasswordValidation} from "./auth.validation";
...
authRouter.patch("/reset-password",validate(forgetPasswordValidation),authService.forgetPassword);
